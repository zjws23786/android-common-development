package com.hua.librarytools.picker.single;
...
import com.hua.librarytools.picker.WheelPicker;
import com.hua.librarytools.picker.adapter.ArrayWheelAdapter;
...
public class SinglePicker<T> extends WheelPicker {
    ...
    private OnSingleWheelLicstener onSingleWheelListener;
     ...
     * 设置滑动监听器
     */
    public void setOnSingleWheelListener(OnSingleWheelLicstener onSingleWheelListener) {
