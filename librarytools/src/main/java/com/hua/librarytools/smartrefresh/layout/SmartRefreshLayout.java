package com.hua.librarytools.smartrefresh.layout;
...
import com.hua.librarytools.smartrefresh.layout.api.DefaultRefreshFooterCreator;
import com.hua.librarytools.smartrefresh.layout.api.DefaultRefreshFooterCreator;
import com.hua.librarytools.smartrefresh.layout.api.DefaultRefreshHeaderCreator;
import com.hua.librarytools.smartrefresh.layout.api.RefreshContent;
import com.hua.librarytools.smartrefresh.layout.api.RefreshFooter;
import com.hua.librarytools.smartrefresh.layout.api.RefreshHeader;
import com.hua.librarytools.smartrefresh.layout.api.RefreshInternal;
import com.hua.librarytools.smartrefresh.layout.api.RefreshKernel;
import com.hua.librarytools.smartrefresh.layout.api.RefreshLayout;
import com.hua.librarytools.smartrefresh.layout.api.ScrollBoundaryDecider;
import com.hua.librarytools.smartrefresh.layout.constant.DimensionStatus;
import com.hua.librarytools.smartrefresh.layout.constant.RefreshState;
import com.hua.librarytools.smartrefresh.layout.constant.SpinnerStyle;
import com.hua.librarytools.smartrefresh.layout.footer.BallPulseFooter;
import com.hua.librarytools.smartrefresh.layout.header.BezierRadarHeader;
import com.hua.librarytools.smartrefresh.layout.impl.RefreshContentWrapper;
import com.hua.librarytools.smartrefresh.layout.impl.RefreshFooterWrapper;
import com.hua.librarytools.smartrefresh.layout.impl.RefreshHeaderWrapper;
import com.hua.librarytools.smartrefresh.layout.listener.OnLoadMoreListener;
import com.hua.librarytools.smartrefresh.layout.listener.OnMultiPurposeListener;
import com.hua.librarytools.smartrefresh.layout.listener.OnRefreshListener;
import com.hua.librarytools.smartrefresh.layout.listener.OnRefreshLoadMoreListener;
import com.hua.librarytools.smartrefresh.layout.listener.OnStateChangedListener;
import com.hua.librarytools.smartrefresh.layout.util.DelayedRunnable;
import com.hua.librarytools.smartrefresh.layout.util.DensityUtil;
import com.hua.librarytools.smartrefresh.layout.util.ScrollBoundaryUtil;
import com.hua.librarytools.smartrefresh.layout.util.ViscousFluidInterpolator;
...
import static com.hua.librarytools.smartrefresh.layout.util.DensityUtil.dp2px;
import static com.hua.librarytools.smartrefresh.layout.util.SmartUtil.fling;
import static com.hua.librarytools.smartrefresh.layout.util.SmartUtil.getColor;
import static com.hua.librarytools.smartrefresh.layout.util.SmartUtil.isScrollableView;
...
//    protected int mFooterExtendHeight;  //扩展高度
    ...
    public SmartRefreshLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTouchSlop = configuration.getScaledTouchSlop(); //控件触发缩放
        mMinimumVelocity = configuration.getScaledMinimumFlingVelocity(); //滑动最小速度
        mMaximumVelocity = configuration.getScaledMaximumFlingVelocity(); //滑动最大速度
...
//                mRefreshContent = new RefreshContentWrapper(view);
    ...
    /**
     * onResume()后面是onAttachedToWindow()，并且onAttachedToWindow只会调用一次，不会受用户操作行为影响。
     * 所以在onAttachedToWindow中进行窗口尺寸的修改再合适不过了
     */
    @Override
