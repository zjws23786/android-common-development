package com.hua.librarytools.smartrefresh.layout.api;
...
//    RefreshLayout setFooterInsetStartPx(int insetPx);
    ...
    /**
     * 设置多功能监听器
     * @param listener 建议使用 {@link com.hua.librarytools.smartrefresh.layout.listener.SimpleMultiPurposeListener}
     * @return RefreshLayout
     */
    ...
    /**
     * 设置滚动边界判断器
     * @param boundary 建议使用 {@link com.hua.librarytools.smartrefresh.layout.impl.ScrollBoundaryDeciderAdapter}
     * @return RefreshLayout
     */
