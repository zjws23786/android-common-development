...
import com.hua.librarytools.selectorphoto.activity.PhotoSelectorActivity;
...
public class ImageSelector {
    ...
    public static void show(@NonNull Activity activity, int resquestCode, int maxCount) {
        PhotoSelectorActivity.show(activity, resquestCode, maxCount);
    }

    public static List<String> getImagePaths(Intent data) {
        return PhotoSelectorActivity.getImagePaths(data);
    }
}